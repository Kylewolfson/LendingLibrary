...
public class Constants {
    ...
    public static final String GOOGLE_API = BuildConfig.GOOGLE_API;
    public static final String GOOGLE_OAUTH = BuildConfig.GOOGLE_OAUTH;
    public static final String GOOGLE_BASE_URL = "https://www.googleapis.com/books/v1/volumes?";
    public static final String GOOGLE_BOOK = "Moby Dick";
}
